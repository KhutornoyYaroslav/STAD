...
_CFG.MODEL.TEMPORAL_FUSION.RESIDUAL_TYPE = 'concat'
_CFG.MODEL.TEMPORAL_FUSION.FREEZE = False
...
# -----------------------------------------------------------------------------
_CFG.INPUT = CN()
_CFG.INPUT.COLOR = "RGB"
_CFG.INPUT.IMAGE_SIZE = [512, 512]
_CFG.INPUT.MAKE_DIVISIBLE_BY = 32
_CFG.INPUT.PAD_LABELS_TO = 40
_CFG.INPUT.PAD_BORDER_VALUE = 114
...
_CFG.DATASET.LABELS = []
_CFG.DATASET.TYPE = ""
_CFG.DATASET.SEQUENCE_DILATE = 1
...
_CFG.DATA_LOADER.PREFECTH_FACTOR = 2
